...
| [Troubleshooting](troubleshooting.md)   | yt-dlp errors, missing captions, false-positive verdicts. |

The top-level [README](../README.md) has the elevator pitch.
